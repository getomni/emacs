...
;; Author: Zoey Pessanha <mdsp@boosting.tech>
;; Keywords: themes
...
(let ((class '((class color) (min-colors 89)))
      ...
      (light (if (true-color-p) "#e5e5e9" "#e1e1e6"))
      (background (if (true-color-p) "#272235" "#191622"))
      (background-darker (if (true-color-p) "#302a41" "#110f17"))
      (background-lighter (if (true-color-p) "#2c263c" "#231e2f"))
      (mode-line (if (true-color-p) "#1c2129" "#222222"))
      (background-red (if (true-color-p) "#4b3030" "#221616"))
      (bright-background-red (if (true-color-p) "#915d5d" "#744b4b"))
      (background-purple (if (true-color-p) "#42304b" "#1e1622"))
      (background-blue (if (true-color-p) "#30304b" "#161622"))
      (bright-background-blue (if (true-color-p) "#5d5d91" "#4b4b74"))
      (background-green (if (true-color-p) "#374b30" "#192216"))
      (bright-background-green (if (true-color-p) "#6a915d" "#55744b"))
      (background-orange (if (true-color-p) "#4b4030" "#221d16"))
      (hl-line (if (true-color-p) "#5a5e78" "#44475a"))
      (grey (if (true-color-p) "#cccccc" "#cccccc"))
      (grey-dark (if (true-color-p) "#666666" "#666666"))
      (highlight (if (true-color-p) "#5a5a6a" "#41414d"))
      (comment (if (true-color-p) "#5e4f87" "#483c67"))
      (orange (if (true-color-p) "#ebac7b" "#e89e64"))
      (orange-light (if (true-color-p) "#f0c5a2" "#eebb92"))
      (red (if (true-color-p) "#ec7a8d" "#e96379"))
      (purple (if (true-color-p) "#a79ccf" "#988bC7"))
      (purple-dark (if (true-color-p) "#7262b3" "#5e4d9f"))
      (blue (if (true-color-p) "#8cd7e5" "#78d1e1"))
      (blue-dark (if (true-color-p) "#42bfd5" "#2baec5"))
      (green (if (true-color-p) "#7de893" "#67e480"))
      (green-light (if (true-color-p) "#a4eeb3" "#94eca6"))
      (peach "PeachPuff3")
      (diff-added-background (if (true-color-p) "#3a624f" "#233b30"))
      (diff-added-refined-background (if (true-color-p) "#229c74" "#186e52"))
      (diff-removed-background (if (true-color-p) "#b93b3b" "#963030"))
      (diff-removed-refined-background (if (true-color-p) "#c86a74" "#bf505c"))
      (diff-current-background (if (true-color-p) "#5c7dbc" "#4668ab"))
      (diff-current-refined-background (if (true-color-p) "#6093cc" "#4580c4")))
